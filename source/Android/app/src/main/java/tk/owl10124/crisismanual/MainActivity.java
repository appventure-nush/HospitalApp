...
public class MainActivity extends AppCompatActivity {
    ...
    public void addCard(SpannableStringBuilder header, SpannableStringBuilder content, int i, boolean expanded) {
        ...
        ch.setRadius(0);
        ch.setCardBackgroundColor(getResources().getColor(container.getChildCount()%2==0?R.color.colorPrimary:R.color.colorPrimaryDark));
        ch.setCardElevation(4);
        ll.addView(ch);

        TextView h = new TextView(getApplicationContext());
        h.setTextColor(getResources().getColor(R.color.colorWhite));
        ...
        if (content.length()>0) {
            ...
            cc.setRadius(0);
            cc.setCardBackgroundColor(getColor(container.getChildCount() % 2 == 0 ? R.color.colorPrimaryLess : R.color.colorPrimaryDarkLess));
            cc.setCardElevation(2);
        ...
        for (String str: a) {
            ...
            for (int i=0;i<str.length();i++) {
                ...
                if (c=='*')
                    ...
                    span.setSpan(new ForegroundColorSpan(ContextCompat.getColor(getApplicationContext(),R.color.colorBackground)),k,span.length(),Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    span.setSpan(new BackgroundColorSpan(ContextCompat.getColor(getApplicationContext(),R.color.colorWhiteTransparent)),k,span.length(),Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    i=e;
                }
